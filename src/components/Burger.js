        ...
        for (let i = 0; i < meat; i++) {
            burger.push (
                <div key={
                    ...
                    className="meatSide"></div>
            );
        }

        if (burger.length === 0) 
            burger.push (
                <p className="pleaseAdd" key="0">Please start adding ingredients!
                </p>
            );
            ...
            <>
                ...
                <div className="ingredientsBlock">
                    ...
                    <div className="ingrBtns">
                        <button onClick={
                                () => this.addRemoveIngredient("add", "lettuce")
                            }
                            className="ingrBtn">
                            {" "}
                            Add
                    ...
                    <div className="ingrBtns">
                        <button onClick={
                                () => this.addRemoveIngredient("add", "tomato")
                            }
                            className="ingrBtn">
                            {" "}
                            Add
                        ...
                        <button onClick={
                                () => this.addRemoveIngredient("remove", "tomato")
                            }
                            className="ingrBtn">
                            {" "}
                            Remove
                    ...
                    <div className="ingrBtns">
                        <button onClick={
                                () => this.addRemoveIngredient("add", "cheese")
                            }
                            className="ingrBtn">
                            {" "}
                            Add
                    ...
                    <div className="ingrBtns">
                        <button onClick={
                                () => this.addRemoveIngredient("add", "meat")
                            }
                            className="ingrBtn">
                            {" "}
                            Add
